...
public class FdaController {
    ...
    public ResponseEntity<?> getFdaList(
            @Parameter(description = "Group identifier", required = true) @RequestHeader("X-Group-Poid") Long groupPoid,
            @Parameter(description = "Company identifier", required = true) @RequestHeader("X-Company-Poid") Long companyPoid,
        ...
        PageResponse<FdaHeaderDto> response = fdaService.getFdaList(groupPoid, companyPoid, transactionPoid, vesselName, etaFrom, etaTo, pageable);
    ...
    public ResponseEntity<?> getFda(
        ...
        return ApiResponse.success("FDA fetched successfully", fdaService.getFdaHeader(transactionPoid, groupPoid, companyPoid));
    }
    ...
    public ResponseEntity<?> createFda(
            ...
            @Parameter(description = "Group identifier", required = true) @RequestHeader("X-Group-Poid") Long groupPoid,
            @Parameter(description = "Company identifier", required = true) @RequestHeader("X-Company-Poid") Long companyPoid,
            @Parameter(description = "User identifier", required = true) @RequestHeader("X-User-Id") String userId
    ) {
        return ApiResponse.success("FDA created successfully", fdaService.createFdaHeader(dto, groupPoid, companyPoid, userId));
    }
    ...
    public ResponseEntity<?> updateFda(
        ...
        return ApiResponse.success("FDA updated successfully", fdaService.updateFdaHeader(transactionPoid, dto, groupPoid, companyPoid, userId));
    }
    ...
    public ResponseEntity<?> deleteFda(
        ...
        fdaService.softDeleteFda(transactionPoid, userId);
    ...
    public ResponseEntity<?> getCharges(
        ...
        PageResponse<FdaChargeDto> charges = fdaService.getCharges(transactionPoid, groupPoid, companyPoid, pageable);
    ...
    public ResponseEntity<?> saveCharges(
        ...
        fdaService.saveCharges(transactionPoid, charges, userId, groupPoid, companyPoid);
    ...
    public ResponseEntity<?> deleteFdaDetail(
        ...
        fdaService.deleteCharge(transactionPoid, detRowId, userId);
    ...
    public ResponseEntity<?> closeFda(
            ...
            @Parameter(description = "Group identifier", required = true) @RequestHeader("X-Group-Poid") Long groupPoid,
            @Parameter(description = "Company identifier", required = true) @RequestHeader("X-Company-Poid") Long companyPoid,
            @Parameter(description = "User identifier", required = true) @RequestHeader("X-User-Poid") Long userPoid
    ) {
        String result = fdaService.closeFda(groupPoid, companyPoid, userPoid, transactionPoid);
    ...
    public ResponseEntity<?> reopenFda(
        ...
        String result = fdaService.reopenFda(groupPoid, companyPoid, userPoid, transactionPoid, fdaReOpenDto);
    ...
    public ResponseEntity<?> submitFda(
        ...
        String result = fdaService.submitFda(groupPoid, companyPoid, userPoid, transactionPoid);
    ...
    public ResponseEntity<?> verifyFda(
        ...
        String result = fdaService.verifyFda(groupPoid, companyPoid, userPoid, transactionPoid);
    ...
    public ResponseEntity<?> returnFda(
        ...
        String result = fdaService.returnFda(groupPoid, companyPoid, userPoid, transactionPoid, request.getCorrectionRemarks());
    ...
    public ResponseEntity<?> supplementaryFda(
        ...
        String result = fdaService.supplementaryFda(groupPoid, companyPoid, userPoid, transactionPoid);
        if (StringUtils.isNotBlank(result) && result.toUpperCase().contains("SUCCESS")) {
    ...
    public ResponseEntity<?> getSupplementaryInfo(
        ...
        List<FdaSupplementaryInfoDto> dtos = fdaService.getSupplementaryInfo(transactionPoid, groupPoid, companyPoid, userPoid);
    ...
    public ResponseEntity<?> closeWithoutAmount(
        ...
        String result = fdaService.closeFdaWithoutAmount(transactionPoid, groupPoid, companyPoid, userPoid, closedRemark);
    ...
    public ResponseEntity<?> getPartyGl(
        ...
        PartyGlResponse response = fdaService.getPartyGl(groupPoid, companyPoid, userPoid, partyPoid, partyType);
    ...
    public ResponseEntity<?> createFromPda(
        ...
        String result = fdaService.createFdaFromPda(groupPoid, companyPoid, userPoid, pdaTransactionPoid);
        if (StringUtils.isNotBlank(result) && result.toUpperCase().contains("SUCCESS")) {
    ...
    public ResponseEntity<?> getPdaLogs(
        ...
        List<PdaLogResponse> logs = fdaService.getPdaLogs(transactionPoid, groupPoid, companyPoid);
...
//            @Parameter(description = "Group identifier", required = true) @RequestHeader("X-Group-Poid") Long groupId,
//            @Parameter(description = "Company identifier", required = true) @RequestHeader("X-Company-Poid") Long companyId,
//            @Parameter(description = "User identifier", required = true) @RequestHeader("X-User-Poid") Long userId,
...
//
//        Resource pdfResource = fdaService.generateFdaReport(transactionPoid, reportType, companyId, userId, groupId);
//
