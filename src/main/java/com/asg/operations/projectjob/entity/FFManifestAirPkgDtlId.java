...
@Getter
public class FFManifestAirPkgDtlId implements Serializable {
    private Long transactionPoid;
    private Long detRowId;

    public FFManifestAirPkgDtlId() {
    }

    public FFManifestAirPkgDtlId(Long transactionPoid, Long detRowId) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        FFManifestAirPkgDtlId that = (FFManifestAirPkgDtlId) o;
