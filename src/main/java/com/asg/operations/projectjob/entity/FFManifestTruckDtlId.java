...
public class FFManifestTruckDtlId {
    private Long transactionPoid;
    private Long detRowId;

    public FFManifestTruckDtlId() {
    }

    public FFManifestTruckDtlId(Long transactionPoid, Long detRowId) {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false;
        FFManifestTruckDtlId that = (FFManifestTruckDtlId) o;
