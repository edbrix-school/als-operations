...
public class ProjectJobMapper {
    ...
    public static void toChargesDto(FFManifestChargesDtl entity, ProjectJobChargesDto dto) {
    ...
    public static void toHdrDto(FFManifestHdr entity, FFManifestHdrDtoResponse dto) {
