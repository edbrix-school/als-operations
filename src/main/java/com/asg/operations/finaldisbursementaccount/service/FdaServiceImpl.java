...
//        CalculationUtils.computeProfitLossRuntime(charges, fdaHeaderDto);
    ...
    public FdaHeaderDto updateFdaHeader(Long transactionPoid, UpdateFdaHeaderRequest dto, Long groupPoid, Long companyPoid, String userId) {
        ...
        LocalDate newTransactionDateForValidation = dto.getTransactionDate() != null ? transactionDate : null;
        validationUtils.validateFinancialAndTransactionPeriodForUpdate(companyPoid, oldTransactionDate, newTransactionDateForValidation);
