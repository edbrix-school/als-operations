...
public class PdaRateTypeControllerTest {
    ...
    void testSoftDelete() throws Exception {
        doNothing().when(service).deleteRateType(eq(1L), eq(1L), eq("testUser"), eq(false), any());
        ...
        verify(service).deleteRateType(eq(1L), eq(1L), eq("testUser"), eq(false), any());
    }

    @Test
    void testHardDelete() throws Exception {
        doNothing().when(service).deleteRateType(eq(1L), eq(1L), eq("testUser"), eq(true), any());
        ...
        verify(service).deleteRateType(eq(1L), eq(1L), eq("testUser"), eq(true), any());
    }
