...
class PdaEntryControllerTest {
    ...
    void setUp() {
        ...
        groupPoid = new BigDecimal(1);
        companyPoid = new BigDecimal(100);
        userId = "USER123";
    ...
    void testCreateFda_Success() throws Exception {
        when(pdaEntryService.createFda(transactionPoid, groupPoid, companyPoid, userId))
        ...
        verify(pdaEntryService, times(1)).createFda(transactionPoid, groupPoid, companyPoid, userId);
    }

    @Test
    void testClearChargeDetails_Success() throws Exception {
        doNothing().when(pdaEntryService).clearChargeDetails(transactionPoid, groupPoid, companyPoid, userId);
        ...
        verify(pdaEntryService, times(1)).clearChargeDetails(transactionPoid, groupPoid, companyPoid, userId);
    }

    @Test
    void testClearVehicleDetails_Success() throws Exception {
        doNothing().when(pdaEntryService).clearVehicleDetails(transactionPoid, groupPoid, companyPoid, userId);
        ...
        verify(pdaEntryService, times(1)).clearVehicleDetails(transactionPoid, groupPoid, companyPoid, userId);
    }

    @Test
    void testImportVehicleDetails_Success() throws Exception {
        doNothing().when(pdaEntryService).importVehicleDetails(transactionPoid, groupPoid, companyPoid, userId);
        ...
        verify(pdaEntryService, times(1)).importVehicleDetails(transactionPoid, groupPoid, companyPoid, userId);
    }
    ...
    void testRecalculateChargeDetails_Success() throws Exception {
        ...
        when(pdaEntryService.recalculateChargeDetails(transactionPoid, groupPoid, companyPoid, userId))
                .thenReturn(List.of(response));
        ...
        verify(pdaEntryService, times(1)).recalculateChargeDetails(transactionPoid, groupPoid, companyPoid, userId);
    }
    ...
    void testLoadDefaultCharges_Success() throws Exception {
        ...
        when(pdaEntryService.loadDefaultCharges(transactionPoid, groupPoid, companyPoid, userId))
                .thenReturn(List.of(response));
        ...
        verify(pdaEntryService, times(1)).loadDefaultCharges(transactionPoid, groupPoid, companyPoid, userId);
    }
